...
class RegisterBrand extends Component {
    ...
    render() {
        ...
        return (
            ...
            <div className="page-bg-regbrand" >
...
export default connect(mapStateToProps, { registerUser })(withRouter(RegisterBrand));